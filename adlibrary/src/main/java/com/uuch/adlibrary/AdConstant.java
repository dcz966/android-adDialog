...
public class AdConstant {
    ...
    public static boolean isConstantAnim(int animType) {
        if (animType == ANIM_UP_TO_DOWN
                || animType == ANIM_DOWN_TO_UP
                || animType == ANIM_LEFT_TO_RIGHT
                || animType == ANIM_RIGHT_TO_LEFT
                || animType == ANIM_UPLEFT_TO_CENTER
                || animType == ANIM_UPRIGHT_TO_CENTER
                || animType == ANIM_DOWNLEFT_TO_CENTER
                || animType == ANIM_DOWNRIGHT_TO_CENTER) {
            return true;
        }
