...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray =
                getContext().obtainStyledAttributes(attrs, R.styleable.ProgressLayout);
    ...
    public void showErrorSmall(OnClickListener onClickListener, String errorMessage,
            String button) {
        this.errorMessage = errorMessage;
        this.errorButton = button;
        switchState(State.ERROR_SMALL, onClickListener);
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            loadingStateProgressBar =
                    (MetaballView) view.findViewById(R.id.loadingStateProgressBar);
    ...
    private void setErrorView(OnClickListener onClickListener) {
        if (errorStateRelativeLayout == null) {
            ...
            errorStateRelativeLayout =
                    (RelativeLayout) view.findViewById(R.id.errorStateRelativeLayout);
    ...
    private void setErrorView4SmallLayout(OnClickListener onClickListener) {
        if (errorStateRelativeLayout == null) {
            ...
            TextView errorStateContentTextView =
                    (TextView) view.findViewById(R.id.errorStateContentTextView);
            errorStateImageView = (ImageView) view.findViewById(R.id.errorStateImageView);
            errorStateButton = (Button) view.findViewById(R.id.errorStateButton);
