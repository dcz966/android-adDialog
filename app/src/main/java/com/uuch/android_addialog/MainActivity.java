...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        adInfo.setActivityImg(
                "https://raw.githubusercontent.com/yipianfengye/android-adDialog/master/images/testImage1.png");
        advList.add(adInfo);

        adInfo = new AdInfo();
        adInfo.setActivityImg(
                "https://raw.githubusercontent.com/yipianfengye/android-adDialog/master/images/testImage2.png");
        advList.add(adInfo);
    }
    ...
    private void initListener() {
            ...
            public void onClick(View v) {
                ...
                adManager.setOnImageClickListener(new AdManager.OnImageClickListener() {
                    ...
                    public void onImageClick(View view, AdInfo advInfo) {
                        Toast.makeText(MainActivity.this, "您点击了ViewPagerItem...",
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }).setPadding(100).setWidthPerHeight(0.5f).showAdDialog(AdConstant.ANIM_UP_TO_DOWN);
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }).setBounciness(20).setSpeed(4).showAdDialog(AdConstant.ANIM_UP_TO_DOWN);
            }
        });
